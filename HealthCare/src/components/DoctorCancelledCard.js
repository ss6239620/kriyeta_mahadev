        ...
        <View style={styles.card}>
            ...
            {isButtonRequired ?
                <View style={{
                    ...
                    <TouchableOpacity
                        style={{ backgroundColor: colorTheme.primaryColor, width: '90%', height: 40, borderRadius: 50, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: colorTheme.primaryColor }}
